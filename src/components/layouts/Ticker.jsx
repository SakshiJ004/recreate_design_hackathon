...
export default function Ticker() {
    return (
        ...
        >
            {/* Label badge */}
            <div
                className="flex-shrink-0 flex items-center gap-1.5 px-3 h-full text-white font-bold tracking-widest uppercase z-10
                    text-[10px] min-w-[90px]
                    sm:text-xs sm:min-w-[100px] sm:px-3
                    lg:text-xs lg:min-w-[110px] lg:px-4"
            ...
            <div className="overflow-hidden flex-1 h-full flex items-center">
                <div
                    className="ticker-content flex items-center font-medium
                        text-sm
                        lg:text-base"
                    style={{ color: '#1F2F5E' }}
                >
                    {[...ANNOUNCEMENTS, ...ANNOUNCEMENTS].map((item, index) => (
                        <div
                            ...
                            className="flex items-center gap-4 whitespace-nowrap group cursor-pointer
                                ...
                                lg:px-6"
                        >
                            <span className="notice-text transition-colors duration-300 group-hover:text-[var(--viva-gold)]
                                px-3
                                sm:px-5
                                lg:px-8">
                                {item.text}
                            </span>
                            <svg width="6" height="6" viewBox="0 0 6 6" fill="var(--viva-gold)" className="flex-shrink-0">
                                <circle cx="3" cy="3" r="3" />
                            </svg>
                        </div>
                    ))}
