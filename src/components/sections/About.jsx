...
const About = () => {
    return (
        <div className="bg-white">
            <section id="about" className="w-full pt-12 pb-12 md:pt-16 md:pb-16 xl:pt-24 xl:pb-18 bg-white">
                <div className="px-4 sm:px-6 md:px-10 xl:px-24">
                    <div className="grid grid-cols-1 xl:grid-cols-5 gap-8 md:gap-12 xl:gap-16 items-center">
                        ...
                        <div className="xl:col-span-2">
                            ...
                            <h2 className="mt-4 xl:mt-5 text-3xl sm:text-4xl md:text-4xl xl:text-5xl font-extrabold text-[var(--viva-navy)] leading-[1.2]">
                                Shaping Leaders<br />
                                <span className="text-[var(--viva-red)]">Since 1988.</span>
                            </h2>

                            <div className="mt-4 xl:mt-5 w-14 h-1 bg-[var(--viva-gold)] rounded-full" />

                            <p className="mt-5 xl:mt-7 text-sm md:text-base xl:text-lg text-gray-500 leading-[1.9]">
                                Viva College, Mumbai — a premier institution under Vishnu Waman Thakur Charitable Trust,
                                offering Arts, Commerce, and Science programs. Affiliated to University of Mumbai and
                                NAAC Accredited, we nurture 7,000+ students every year.
                            </p>
                            ...
                            {/* Feature list */}
                            <div className="mt-6 xl:mt-8 grid grid-cols-1 gap-3 xl:gap-4">
                                {[
                                    { icon: "🏛️", title: "NAAC Accredited", desc: "Recognized for academic quality & excellence" },
                                    { icon: "🎓", title: "University of Mumbai", desc: "Affiliated & recognized institution since 1988" },
                                ].map((item, i) => (
                                    <div key={i} className="flex items-start gap-3 xl:gap-4 p-3 xl:p-4 rounded-xl hover:bg-gray-50 transition-all duration-200">
                                        ...
                                        <div>
                                            <div className="font-bold text-[var(--viva-navy)] text-xs xl:text-sm">{item.title}</div>
                                            <div className="text-gray-500 text-xs xl:text-sm mt-0.5">{item.desc}</div>
                                        </div>
                                    </div>
                                ))}
                            </div>

                            <div className="mt-6 xl:mt-8 flex flex-wrap gap-3 xl:gap-4">
                                <button className="px-6 xl:px-8 py-3 xl:py-3.5 bg-[var(--viva-red)] text-white font-bold rounded-full hover:bg-red-700 transition-all duration-300 text-xs xl:text-sm shadow-md hover:shadow-lg hover:scale-105">
                                    Learn More →
                                </button>
                                <button className="px-6 xl:px-8 py-3 xl:py-3.5 border-2 border-[var(--viva-navy)] text-[var(--viva-navy)] font-bold rounded-full hover:bg-[var(--viva-navy)] hover:text-white transition-all duration-300 text-xs xl:text-sm">
                                    Virtual Tour
                                </button>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col gap-4 xl:gap-6 xl:col-span-3">
                            ...
                            {/* Stats Grid */}
                            <div className="grid grid-cols-2 md:grid-cols-3 gap-3 xl:gap-4">
                                {stats.map((stat, i) => (
                                    <div key={i}
                                        className="relative bg-white border border-gray-100 rounded-2xl p-3 xl:p-5 flex flex-col items-start shadow-sm hover:shadow-xl hover:border-[var(--viva-red)] transition-all duration-300 group overflow-hidden"
                                    >
                                        <div className="absolute top-0 right-0 w-12 xl:w-16 h-12 xl:h-16 bg-[#FFF5F5] rounded-bl-[50px] group-hover:bg-[#FFE8E8] transition-all duration-300" />
                                        <div className="relative z-10 p-1.5 xl:p-2 bg-[#FFF5F5] rounded-xl text-[var(--viva-red)] group-hover:scale-110 transition-transform duration-300">
                                            {stat.icon}
                                        </div>
                                        <div className="mt-3 xl:mt-6 text-xl md:text-2xl xl:text-3xl font-extrabold text-[var(--viva-navy)]">
                                            {stat.number}
                                        </div>
                                        <div className="mt-0.5 xl:mt-1 text-[10px] xl:text-xs font-medium text-gray-500 leading-snug">
                                            {stat.label}
                                        </div>
                                        <div className="absolute bottom-0 left-0 h-[3px] w-0 group-hover:w-full bg-[var(--viva-red)] transition-all duration-500 rounded-b-2xl" />
                                    </div>
                            ...
                            {/* Journey */}
                            <div className="mt-0 xl:mt-2 bg-[var(--viva-navy)] rounded-2xl p-5 md:p-7 xl:p-10">
                                ...
                                <div className="hidden sm:flex relative items-center justify-between top-3">
                                    ...
                                    {milestones.map((m, i) => (
                                        <div key={i} className="relative flex flex-col items-center gap-2 group flex-1">
                                            <div className="w-10 h-10 md:w-12 md:h-12 xl:w-14 xl:h-14 rounded-full bg-[var(--viva-red)] flex items-center justify-center text-white font-extrabold text-[11px] md:text-[13px] xl:text-[14px] z-10 group-hover:scale-110 transition-transform duration-300 shadow-lg border-2 border-white/20">
                                                {m.year}
                                            </div>
                                            <div className="text-[10px] md:text-xs xl:text-sm font-semibold text-white/70 group-hover:text-white transition-colors duration-200 text-center">
                                                {m.text}
                                            </div>
                                        </div>
                                    ))}
                                ...
                                <div className="flex sm:hidden flex-col gap-4 relative">
                                    ...
                                    {milestones.map((m, i) => (
                                        <div key={i} className="flex items-start gap-4 relative">
                                            ...
                                            <div className="text-xs font-semibold text-white/70 mt-2.5">
                                                {m.text}
                                            </div>
                                        </div>
                                    ))}
