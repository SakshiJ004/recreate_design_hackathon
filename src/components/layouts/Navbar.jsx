...
//                     {/* Dropdown — position: fixed, Hero च्या वर */}
//                     {portalOpen && (
//                         <div
//                             style={{
//                                 position: 'fixed',
...
//                                 zIndex: 9999,
//                             }}
//                             className="bg-white rounded-2xl shadow-2xl border border-gray-100 w-[200px] overflow-hidden"
//                         >
//                             <div className="bg-[var(--viva-navy)] px-4 py-2.5">
//                                 <p className="text-white font-bold text-[10px] tracking-widest uppercase">Quick Access</p>
//                             </div>
